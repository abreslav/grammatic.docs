...
\begin{figure}[htbp]
\center
\includegraphics[width=.9\textwidth]{pictures/#1.pdf}
\caption{#2}\label{#1}
\end{figure}}
...
\newcommand{\CClass}[3]{\mathbf{[class]}\;#1 : #2 \left\{#3\right\}}
\newcommand{\AClass}[3]{\mathbf{(class)}\;#1 : #2 \left\{#3\right\}}
...
\newcommand{\Aggregated}[1]{\overline{A}\left(#1\right)}
