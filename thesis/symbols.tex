...
\newcommand{\Inst}[2]{\InstSign_{#1} \left\langle #2 \right\rangle}%
\newcommand{\InstL}[2]{\InstSign_{#1}^{L} \left\langle #2 \right\rangle}%
\newcommand{\InstS}[2]{\InstSign_{#1}^{S} \left\langle #2 \right\rangle}%
