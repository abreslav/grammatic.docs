...
\newcommand{\Inst}[2]{\InstSign_{m, #1} \left\langle #2 \right\rangle}%
\newcommand{\InstC}[3]{\InstSign_{#1, #2} \left\langle #3 \right\rangle}%
\newcommand{\InstL}[2]{\InstSign_{m, #1}^{L} \left\langle #2 \right\rangle}%
\newcommand{\InstS}[2]{\InstSign_{m, #1}^{S} \left\langle #2 \right\rangle}%
...
\newcounter{typerule}
\renewcommand{\thetyperule}{\thesection.\arabic{typerule}}

\newcommand{\rulelabel}[1]{\refstepcounter{typerule}(\thetyperule)\label{#1}}
\newcommand{\myinfer}[3][]{\infer[\mbox{#1}]{#2}{#3}}
\newcommand{\trule}[3]{%
\myinfer[\rulelabel{#3}]{#2}{#1}%(\mbox{\textsc{#3}})%
}%
\newcommand{\tinfer}[3][]{\infer[\rulelabel{#1}]{#2}{#3}}
...
\newcommand{\CopyRM}[2]{\mathsf{Copy}_{#1}\left(#2\right)}
\newcommand{\Copy}[1]{\CopyRM{m}{#1}}
...
\newcommand{\LI}[1]{\underline{#1}}
\newcommand{\ELI}[1]{\overline{#1}}

\newcommand{\SI}[1]{\underline{\underline{#1}}}
\newcommand{\ESI}[1]{\overline{\overline{#1}}}