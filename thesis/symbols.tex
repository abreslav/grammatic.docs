...
\newcommand{\Inst}[2]{\mathcal{I}_{#1} \left\langle #2 \right\rangle}%
\newcommand{\InstL}[2]{\mathcal{I}_{#1}^{L} \left\langle #2 \right\rangle}%
\newcommand{\InstS}[2]{\mathcal{I}_{#1}^{L} \left\langle #2 \right\rangle}%
...
\newcommand{\Copy}[1]{\mathsf{Copy}(#1)}
