...
\begin{center}
Бреслав А. А. \\
\bf Автоматизация разработки механизмов композиции в предметно-ориентированных языках
\end{center}
...
\part{Предварительные сведения из области технологии разработки компьютерных языков}\label{background.part}
