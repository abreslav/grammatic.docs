...
Given an infinite set of variables $\mathcal{V}$, finite set of types $\mathcal{T}$ and value constructors $\mathcal{C}$ (we denote the set of all possible terms that use constructors from $\mathcal{C}$ as $\overline{\mathcal{C}}$),
